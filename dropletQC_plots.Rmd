...
```{r}
plot <- FeaturePlot_scCustom(sobj, features = "nuclear_fraction", raster = FALSE,
...
```{r}
plot1 <- FeaturePlot_scCustom(sobj, features = "APOC1", raster = FALSE,
                              colors_use = viridis_light_high) +
  ggtitle(expression(italic("APOC1")))
plot1
plot2 <- FeaturePlot_scCustom(sobj, features = "MARCO", raster = FALSE,
                              colors_use = viridis_light_high) +
