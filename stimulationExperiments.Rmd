...
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL2.pdf")
FeaturePlot(scSeurat, feature = "IL2", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "IL4", split.by = "tissue_type") # Only in PMAIO cluster 2
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL4.pdf")
...
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL6.pdf")
FeaturePlot(scSeurat, feature = "IL6", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "IL6-1", split.by = "tissue_type") # No signal
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL6-1.pdf")
FeaturePlot(scSeurat, feature = "IL6", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "IL7", split.by = "tissue_type") # More in PMAIO cluster 4/5
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL7.pdf")
FeaturePlot(scSeurat, feature = "IL7", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "IL10", split.by = "tissue_type") # More in PMAIO cluster 2
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL10.pdf")
FeaturePlot(scSeurat, feature = "IL10", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "IL12A", split.by = "tissue_type") # No signal
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL12A.pdf")
...
pdf(file = "figures/stimulation/downsampled_UMAP_split_TGFB1.pdf")
FeaturePlot(scSeurat, feature = "TGFB1", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "IFNG", split.by = "tissue_type") # More in PMAIO cluster 2
pdf(file = "figures/stimulation/downsampled_UMAP_split_IFNG.pdf")
FeaturePlot(scSeurat, feature = "IFNG", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "TGFA", split.by = "tissue_type")
pdf(file = "figures/stimulation/downsampled_UMAP_split_TGFA.pdf")
FeaturePlot(scSeurat, feature = "TGFA", split.by = "tissue_type")
dev.off()
FeaturePlot(scSeurat, feature = "TNF", split.by = "tissue_type")
pdf(file = "figures/stimulation/downsampled_UMAP_split_TNF.pdf")
FeaturePlot(scSeurat, feature = "TNF", split.by = "tissue_type")
dev.off()
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL18.pdf")
FeaturePlot(scSeurat, feature = "IL18", split.by = "tissue_type")
dev.off()
pdf(file = "figures/stimulation/downsampled_UMAP_split_IL2RA.pdf")
FeaturePlot(scSeurat, feature = "IL2RA", split.by = "tissue_type")
dev.off()
```
...
```{r}
genes <- c("IL2","IL4","IL6","IL6-1","IL7","IL10","IL12A","TGFB1","TNF","IL18","IL2RA")
for(gene in genes) {
