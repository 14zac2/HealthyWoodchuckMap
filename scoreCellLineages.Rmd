...
mySigs$Kupffer_Cells <- c("CD68","LYZ-1","MARCO","CD5L","C1QB","C1QC","FYB1","ITGAM","ITGAD","TREM2",
                          "MAF","APOE","FTL")
mySigs$Myeloid_Cells <- c("CD14","LCP2","FCGR3A;FCGR3B","VCAN","S100A8","S100A9","S100A12")
mySigs$Mesenchymal_Cells <- c("ACTA2")
mySigs$Megakaryocytes <- c("PPBP","PF4;PF4V1")
mySigs$Hematopoietic_Stem_Cells <- c("VIM","CD74")
mySigs$B_Cells <- c("BCL2","JCHAIN","MZB1","IGLL5-1","CD79B","MS4A1","DGKK","CD72")
mySigs$Dendritic_Cells <- c("CD1C","CD1E","CLEC9A")
mySigs$Cholangiocytes <- c("KRT19","CFTR","CAPN12")
