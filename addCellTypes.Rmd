...
- CD3+ NK/T cells (XCL1;XCL2+): 6, 24, 39
- CD3+ Naive regulatory T cells (LEF1+): 14
...
- CD3+/CD8A+/NKG7+ NK/T cells (XCL1;XCL2+): 4, 7
...
clusters <- gsub('\\b2\\b', "CD3+/GATA3+/MAF+ TH2-like T cells 1",
                 clusters,
                 perl = TRUE)
clusters <- gsub('\\b4\\b|\\b7\\b', "CD3+/CD8A+/NKG7+ NK/T cells",
                 clusters,
                 perl = TRUE)
